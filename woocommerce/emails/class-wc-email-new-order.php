...
if ( ! class_exists( 'WC_Email_New_Order_Aralco' ) ) :
	 ...
	 *
	 * @class       WC_Email_New_Order_Aralco
	 * @version     2.0.0
	 * @package     WooCommerce/Classes/Emails
	 * @extends     WC_Email
	 */
	class WC_Email_New_Order_Aralco extends WC_Email {
		...
		public function __construct() {
			$this->id             = 'new_order';
			$this->title          = __( 'New order/quote', 'woocommerce' );
			$this->description    = __( 'New order/quote emails are sent to chosen recipient(s) when a new order/quote is received.', 'woocommerce' );
		...
		public function get_default_subject() {
			return __( '[{site_title}]: New {trans_type} #{order_number}', ARALCO_SLUG );
		}
		...
		public function get_default_heading() {
			return __( 'New {trans_type}: #{order_number}', ARALCO_SLUG );
		}
...
return new WC_Email_New_Order_Aralco();
