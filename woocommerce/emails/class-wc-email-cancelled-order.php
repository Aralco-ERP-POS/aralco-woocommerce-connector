...
if ( ! class_exists( 'WC_Email_Cancelled_Order_Aralco', false ) ) :
	 ...
	 *
	 * @class       WC_Email_Cancelled_Order_Aralco
	 * @version     2.2.7
	 * @package     WooCommerce/Classes/Emails
	 * @extends     WC_Email
	 */
	class WC_Email_Cancelled_Order_Aralco extends WC_Email {
		...
		public function __construct() {
			...
			$this->title          = __( 'Cancelled order/quote', 'woocommerce' );
			$this->description    = __( 'Cancelled order/quote emails are sent to chosen recipient(s) when orders/quote have been marked cancelled (if they were previously processing or on-hold).', 'woocommerce' );
		...
		public function get_default_subject() {
			return __( '[{site_title}]: {trans_type} #{order_number} has been cancelled', ARALCO_SLUG );
		}
		...
		public function get_default_heading() {
			return __( '{trans_type} Cancelled: #{order_number}', ARALCO_SLUG );
		}
...
return new WC_Email_Cancelled_Order_Aralco();
