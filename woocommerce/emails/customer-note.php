...
<p><?php
    ...
    $text = esc_html__( 'The following note has been added to your order:', 'woocommerce' );
    if($use_quote) {
        $text = esc_html__( 'The following note has been added to your quote:', ARALCO_SLUG );
    }
...
<p><?php
    ...
    $text = esc_html__( 'As a reminder, here are your order details:', 'woocommerce' );
    if($use_quote) {
        $text = esc_html__( 'As a reminder, here are your quote details:', ARALCO_SLUG );
    }
