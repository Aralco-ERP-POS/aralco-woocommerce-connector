...
if ( ! class_exists( 'WC_Email_Failed_Order_Aralco', false ) ) :
	 ...
	 *
	 * @class       WC_Email_Failed_Order_Aralco
	 * @version     2.5.0
	 * @package     WooCommerce/Classes/Emails
	 * @extends     WC_Email
	 */
	class WC_Email_Failed_Order_Aralco extends WC_Email {
		...
		public function __construct() {
			...
			$this->title          = __( 'Failed order/quote', 'woocommerce' );
			$this->description    = __( 'Failed order/quote emails are sent to chosen recipient(s) when orders/quotes have been marked failed (if they were previously pending or on-hold).', 'woocommerce' );
		...
		public function get_default_subject() {
			return __( '[{site_title}]: {trans_type} #{order_number} has failed', ARALCO_SLUG );
		}
		...
		public function get_default_heading() {
			return __( '{trans_type} Failed: #{order_number}', ARALCO_SLUG );
		}
...
return new WC_Email_Failed_Order_Aralco();
