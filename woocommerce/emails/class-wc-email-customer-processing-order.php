...
if ( ! class_exists( 'WC_Email_Customer_Processing_Order_Aralco', false ) ) :
	 ...
	 *
	 * @class       WC_Email_Customer_Processing_Order_Aralco
	 * @version     3.5.0
	 * @package     WooCommerce/Classes/Emails
	 * @extends     WC_Email
	 */
	class WC_Email_Customer_Processing_Order_Aralco extends WC_Email {
		...
		public function __construct() {
			...
			$this->title          = __( 'Processing order/quote', 'woocommerce' );
			$this->description    = __( 'This is an order/quote notification sent to customers containing order/quote details after payment.', 'woocommerce' );
...
return new WC_Email_Customer_Processing_Order_Aralco();
